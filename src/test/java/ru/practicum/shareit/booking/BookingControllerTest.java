...
class BookingControllerTest {
    ...
    @Test
    void testCreateBookingItemIdNull() throws Exception {
        BookingDto bookingItemIdNull = new BookingDto(
                1L,
                LocalDateTime.of(2024, 1, 1, 1, 1, 0),
                LocalDateTime.of(2025, 1, 1, 1, 1, 0),
                null,
        ...
        when(bookingService.create(1L, bookingItemIdNull))
    ...
    @Test
    void testCreateBookingEndBeforeStart() throws Exception {
        BookingDto bookingEndBeforeStart = new BookingDto(
                1L,
                LocalDateTime.of(2025, 1, 1, 1, 1, 0),
                LocalDateTime.of(2024, 1, 1, 1, 1, 0),
                1L,
        ...
        when(bookingService.create(1L, bookingEndBeforeStart))
